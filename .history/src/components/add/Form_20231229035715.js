        ...
        <form onSubmit={handleSubmit} className="book-form">
            ...
            <div className="grid grid-cols-2 gap-8 pb-4">
                ...
                <div className="space-y-2">
                    ...
                    <input onChange={(e) => setRating(e.target.value)} required className="text-input" type="number" id="lws-rating" name="rating" min="1"
                        max="5" />
                </div>
            </div>

            <div className="flex items-center">
                <input onClick={() => setFeatured(!featured)} id="lws-featured" type="checkbox" name="featured" className="w-4 h-4" />
